...
public class JCustomerDao2 {
	...
	public JCustomer login(String id, String password) throws SQLException {
		...
		String sql = "select custom_id name"
				+ "from j_custome where custom_id = ? and password = ?";
...
//LoginMain에서 사용자에게 아이디 >>>, 패스워드 >>>>  '로그인 성공했습니다.' 또는 '입력한 계정정보가 틀립니다.' 출력
//로그인 처리 결과 '로그인 성공했습니다. xxx님 환영합니다.' 또는 '입력한 계정 정보가 틀립니다.' 출력